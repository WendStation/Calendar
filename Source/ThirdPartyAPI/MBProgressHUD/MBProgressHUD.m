...
@property (atomic, MB_STRONG) NSTimer *maxShowTimer;
@end
...
@synthesize maxShowTime;
@synthesize graceTimer;
@synthesize minShowTimer;
@synthesize maxShowTimer;
...
- (void)show:(BOOL)animated {
    ...
    if (self.maxShowTime > 0.0) {
        self.maxShowTimer = [NSTimer scheduledTimerWithTimeInterval:self.maxShowTime target:self
                                                         selector:@selector(handleMaxShowTimer:) userInfo:nil repeats:NO];
    }
}
