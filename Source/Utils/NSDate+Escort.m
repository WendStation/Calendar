...
- (NSDate *)dateNextHour {
    NSCalendar *calendar = [NSDate AZ_currentCalendar];
    NSDateComponents *components = [calendar components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond fromDate:[self dateByAddingHours:1]];
    components.minute = 0;
    components.second = 0;
...
- (NSString *)weekDes {
    ...
    return [NSString stringWithFormat:@"%@", [weekday objectAtIndex:[self weekday] - 1]];
}
